...
export const iconSubset = {
  ...
  cilSun, cilUser, cilClock, cilPowerStandby, cilMemory, cilXCircle, cilSitemap, cilWarning, cilFeaturedPlaylist, cilBarChart, cilShieldAlt
};
